            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Berisi Data Materi-Materi Pada Website Special School</p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-primary" ><a href="./tutorial.php?id=<?= base64_encode($data->id_materi); ?>"><span class="fa fa-info-circle"> More</a></button>
                            <button class="btn btn-primary" ><a href="./edit_materi.php?id=<?= base64_encode($data->id_materi); ?>"><span class="fa fa-pencil"> Edit</a></button>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
