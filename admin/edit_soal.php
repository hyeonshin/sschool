...
if (isset($_POST['kirim'])) {
    ...
    {
    $edit = $lib->edit_soal($id_soal, $gambar, $soal, $pil_a, $pil_b, $pil_c, $pil_d, $kj, $id_tutorial);
    }
    else{
        $edit = "SAMA";
    }
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Mengubah Data Soal</p>
                </div>
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="kirim" href="./edit_soal.php?id=<?= base64_encode($data->id_soal); ?>">Update Soal</button>
