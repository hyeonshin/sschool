...
if (isset($_POST['kirim'])) {
	...
	$edit = $lib->edit_materi($id_materi, $nama_materi, $ket);
	if ($edit == "SUCCESS") {
		echo "
		<script>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Mengubah Data Materi</p>
                </div>
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="kirim" href="./edit_materi.php?id=<?= base64_encode($data->id_materi); ?>">Update Materi</button>
