...
if (isset($_POST['kirim'])) {
	...
	$edit = $lib->edit_user($id_user, $username, $nama_user, $email, $id_materi);
	if ($edit == "SUCCESS") {
		echo "
		<script>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="kirim" href="./edit_user.php?id=<?= base64_encode($data->id_user); ?>">Update Profile</button>
